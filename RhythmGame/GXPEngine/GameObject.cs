...
namespace GXPEngine
{
	...
	public abstract class GameObject : Transformable, ICloneable
	{
		...
		/// </param> 
		public GameObject(bool addCollider=false) => ResetParameters(addCollider);
	
		public void ResetParameters(bool addCollider = false)
		{
			if (addCollider)
			{
		...
		public void Revive() => destroyed = false;
